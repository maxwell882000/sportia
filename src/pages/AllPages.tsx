...
import {$currentPage, $isAnimateSideBar, $isCategoriesDisappeared} from "../states/store.ts";
...
function AllPages() {
    ...
    return <>
        ...
        {currentPage === Pages.BOOK && (<BookPage className={animateCloseOpenSideBar}/>)}
    </>
}
